...
RSpec.describe Armature::Snapshot::Store do
  let(:storage_path) { Dir.mktmpdir("armature_test") }
  let(:connection) { ActiveRecord::Base.connection }
  let(:adapter) { Armature::Snapshot::Adapters::SqliteAdapter.new(connection) }
